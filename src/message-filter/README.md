...
curl -X POST http://127.0.0.1:5000/receiverequest -H "Content-Type: application/json" -H "Ce-Specversion: 1.0" -H "Ce-Type: dev.dapr.sample" -H "Ce-Source: dev.dapr.samples/message-filter" -H "Ce-Id: 536808d3-88be-4077-9d7a-a3f162705f79" -d '{"id": "2", "humidity": "3", "temperature": "4", "name": "Dennis", "message": "Why I Sing the Blues"}'
```
...
az acr build --registry $REGISTRY_NAME --image message-filter:works .
```
